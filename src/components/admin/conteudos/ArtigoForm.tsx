...
export function ArtigoForm({ initialData, categorias, onSubmit, onCancel, isSubmitting }: Props) {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea className="min-h-[150px]" placeholder="Conteúdo completo..." {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
